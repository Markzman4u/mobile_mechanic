...
CREATE INDEX IF NOT EXISTS idx_walkin_id ON requests(walkin_id);
CREATE INDEX IF NOT EXISTS idx_mechanic_id ON requests(mechanic_id);
CREATE INDEX IF NOT EXISTS idx_request_id ON services(request_id);
