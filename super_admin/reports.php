...
// ── 8. Revenue by month (completed jobs only, last 12 months or within filter) ─
...
if (!empty($revenueMonthly)) {
    ...
    // re-sort chronologically for charts
...
<style>
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;margin-bottom:20px;">
        ...
        <a href="<?php echo getBasePath(); ?>super_admin/history.php"
    ...
    <form method="get" class="filter-bar">
        ...
        <?php if ($dateFrom || $dateTo): ?>
            <a href="<?php echo getBasePath(); ?>super_admin/reports.php"
...
function initRevenue() {
                    ...
                    tooltip: {
                        callbacks: {
                            ...
                            afterLabel: ctx => {
                                ...
                                return [
                                    'Jobs: ' + r.job_count,
                                    'Avg: $' + Number(r.avg_per_job).toFixed(2)
                                ];
                            }
                        }
                    }
    ...
    // Problem type horizontal bar chart
